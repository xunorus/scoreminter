...
// define the item
contract MSharesCollabMarketV4 {
////////////////////////////////////    
//  VARIABLES
////////////////////////////////////    
    ...
    mapping(address => mapping(uint256 => bool)) activeItems;//for each token address we will check so that the tokenId of that address  has a flag of eather true or false, where true is that this item is currently on sale. The purpose of this is to avoid loop through the array. 
    
    
    event itemAdded(uint256 id, uint256 tokenId, address tokenAddress, uint256 askingPrice);// event for when item is added to marketplace
